  ...
  return (
    <section className="section-space">
      <div className="shell-container">
        <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[#1A2E5A] p-8 shadow-[0_12px_40px_rgba(26,46,90,0.06)] md:p-12">
          <div className="grid gap-10 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
            <div className="space-y-5">
              <span className="eyebrow text-white/64">Start a project</span>
