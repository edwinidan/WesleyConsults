        ...
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center">
            <span className="font-display font-bold text-2xl text-gray-900 tracking-tight">
              Wesley<span className="text-primary">Consults</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              to="/contact"
              className="bg-primary text-white px-5 py-2.5 rounded-full font-medium hover:bg-red-700 transition-colors shadow-sm hover:shadow-md"
            >
              Get Started
            </Link>
          </div>
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4">
                <Link
                  to="/contact"
                  className="block w-full text-center bg-primary text-white px-5 py-3 rounded-lg font-medium hover:bg-red-700 transition-colors"
                >
                  Get Started
                </Link>
              </div>
